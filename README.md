...
## Audit سریع requirements

- `.gitignore` وجود دارد: verified
- static frontend پیاده‌سازی شده: verified
- GitHub Actions workflow برای Pages وجود دارد: verified
- README شامل گزارش و پاسخ سوال‌ها است: verified
- branchهای معنادار وجود دارند: verified
- حداقل 20 commit معنادار در history وجود دارد: verified
- حداقل 2 conflict در history حل شده‌اند: verified
- branch `main` در GitHub protected است: needs GitHub-side verification
- ادغام‌ها از طریق pull request انجام شده‌اند: needs GitHub-side verification for the remote record
- لینک دقیق GitHub Pages در README آمده است: verified
- ضبط ویدئو تحویل شده است: needs manual submission verification
...
workflow فقط پوشه‌ی `site/` را منتشر می‌کند تا Pages به‌صورت مستقیم فایل‌های static را سرو کند.
